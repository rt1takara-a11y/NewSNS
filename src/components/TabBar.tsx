...
export function TabBar() {
  ...
  return <nav className="tabbar" aria-label="メインナビゲーション">
    ...
    <div className="nav-foot"><span className="eyebrow">MAKE ROOM FOR NOW</span><p>今月の自分で、<br />つながろう。</p><span className="handle">{live ? "RE:ME · 今月だけのつながり" : "体験版 · データは保存されません"}</span></div>
  </nav>;
}
