...
export function TabBar() {
  ...
  return <nav className="tabbar" aria-label="メインナビゲーション">
    <Link href="/" className="brand" aria-label="NewSNS ホーム"><span className="brand-symbol"><Icon name="reset" /></span><span>NewSNS<span className="brand-caption">A NEW MONTH. A NEW YOU.</span></span></Link>
