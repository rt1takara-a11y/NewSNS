...
export function TabBar() {
  ...
  return <nav className="tabbar" aria-label="メインナビゲーション">
    <Link href="/" className="brand" aria-label="RE:ME ホーム"><span className="brand-symbol"><Icon name="reset" /></span><span>RE:ME<span className="brand-caption">A NEW WEEK. A NEW YOU.</span></span></Link>
    ...
    <div className="nav-foot"><span className="eyebrow">MAKE ROOM FOR NOW</span><p>今週の自分で、<br />つながろう。</p><span className="handle">{live ? "RE:ME · 今週だけのつながり" : "体験版 · データは保存されません"}</span></div>
  </nav>;
}
