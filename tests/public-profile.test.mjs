...
const person = { publicId: 'current-person', displayName: '今週の人', icon: '🌙', bio: '自己紹介' };
...
test('profile links use only the encoded weekly public ID', () => {
...
test('missing, malformed, internal, email and previous-week IDs do not resolve', () => {
